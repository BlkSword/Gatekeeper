...
const filteredFirewallRules = computed(() => {
  ...
  return firewallRules.value.filter(item =>
    item.name.toLowerCase().includes(query) ||
    item.enabled.toLowerCase().includes(query) ||
    item.direction.toLowerCase().includes(query) ||
    item.profile.toLowerCase().includes(query) ||
    item.group.toLowerCase().includes(query) ||
    item.localIp.toLowerCase().includes(query) ||
    item.remoteIp.toLowerCase().includes(query) ||
    item.protocol.toLowerCase().includes(query) ||
    item.localPort.toLowerCase().includes(query) ||
    item.remotePort.toLowerCase().includes(query) ||
    item.edgeTraversal.toLowerCase().includes(query) ||
